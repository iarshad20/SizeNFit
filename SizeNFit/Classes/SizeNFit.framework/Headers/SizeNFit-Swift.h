...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SizeNFit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC8SizeNFit19BrandCalculationApi")
@interface BrandCalculationApi : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8SizeNFit17BrandSizeStyleApi")
@interface BrandSizeStyleApi : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8SizeNFit14CheckForButton")
@interface CheckForButton : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSString * _Nonnull productCode;)
+ (NSString * _Nonnull)productCode SWIFT_WARN_UNUSED_RESULT;
+ (void)setProductCode:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSString * _Nonnull profileType;)
+ (NSString * _Nonnull)profileType SWIFT_WARN_UNUSED_RESULT;
+ (void)setProfileType:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSString * _Nonnull productType;)
+ (NSString * _Nonnull)productType SWIFT_WARN_UNUSED_RESULT;
+ (void)setProductType:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSString * _Nonnull website;)
+ (NSString * _Nonnull)website SWIFT_WARN_UNUSED_RESULT;
+ (void)setWebsite:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSString * _Nonnull userName;)
+ (NSString * _Nonnull)userName SWIFT_WARN_UNUSED_RESULT;
+ (void)setUserName:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger statusCode;)
+ (NSInteger)statusCode SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC8SizeNFit18CircleProgressView")
...
SWIFT_CLASS("_TtC8SizeNFit26HeightWeightCalculationApi")
@interface HeightWeightCalculationApi : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSBundle;

SWIFT_CLASS("_TtC8SizeNFit37HeightWeightCalculationViewController")
@interface HeightWeightCalculationViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8SizeNFit15IQBarButtonItem")
...
SWIFT_CLASS("_TtC8SizeNFit28IQBarButtonItemConfiguration")
...
SWIFT_CLASS("_TtC8SizeNFit12IQInvocation")
...
SWIFT_CLASS("_TtC8SizeNFit17IQKeyboardManager")
...
SWIFT_CLASS("_TtC8SizeNFit26IQKeyboardReturnKeyHandler")
...
- (void)textFieldDidEndEditing:(UITextField * _Nonnull)textField reason:(enum UITextFieldDidEndEditingReason)reason SWIFT_AVAILABILITY(ios,introduced=10.0);
...
SWIFT_CLASS("_TtC8SizeNFit18IQPreviousNextView")
...
SWIFT_CLASS("_TtC8SizeNFit10IQTextView")
...
SWIFT_CLASS("_TtC8SizeNFit20IQTitleBarButtonItem")
...
SWIFT_CLASS("_TtC8SizeNFit9IQToolbar")
...
SWIFT_CLASS("_TtC8SizeNFit12JMMarkSlider")
@interface JMMarkSlider : UISlider
@property (nonatomic) float markWidth;
@property (nonatomic, strong) UIColor * _Nonnull markColor;
@property (nonatomic, strong) UIColor * _Nonnull selectedBarColor;
@property (nonatomic, strong) UIColor * _Nonnull unselectedBarColor;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull markPositions;
@property (nonatomic, strong) UIImage * _Null_unspecified handlerImage;
@property (nonatomic, strong) UIColor * _Null_unspecified handlerColor;
- (void)drawRect:(CGRect)rect;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8SizeNFit15SearchTextField")
...
@interface SearchTextField (SWIFT_EXTENSION(SizeNFit)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8SizeNFit29SelectBrandSIzeViewController")
@interface SelectBrandSIzeViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
...
SWIFT_CLASS("_TtC8SizeNFit25SelectBrandViewController")
...
SWIFT_CLASS("_TtC8SizeNFit25SizenfitWidgetButtonCheck")
@interface SizenfitWidgetButtonCheck : NSObject
@property (nonatomic, strong) NSString * _Nonnull productCode;
@property (nonatomic, strong) NSString * _Nonnull profileType;
@property (nonatomic, strong) NSString * _Nonnull productType;
@property (nonatomic, strong) NSString * _Nonnull userName;
@property (nonatomic, strong) NSString * _Nonnull website;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8SizeNFit21TechSpecListDetailApi")
@interface TechSpecListDetailApi : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface UIScrollView (SWIFT_EXTENSION(SizeNFit))
...
@interface UIView (SWIFT_EXTENSION(SizeNFit))
/// <hr/>
...
@interface UIViewController (SWIFT_EXTENSION(SizeNFit))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
...
SWIFT_CLASS("_TtC8SizeNFit18UserSelectedValues")
@interface UserSelectedValues : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger height;)
+ (NSInteger)height SWIFT_WARN_UNUSED_RESULT;
+ (void)setHeight:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger weight;)
+ (NSInteger)weight SWIFT_WARN_UNUSED_RESULT;
+ (void)setWeight:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger fitprefer;)
+ (NSInteger)fitprefer SWIFT_WARN_UNUSED_RESULT;
+ (void)setFitprefer:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger shape;)
+ (NSInteger)shape SWIFT_WARN_UNUSED_RESULT;
+ (void)setShape:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger nextScreen;)
+ (NSInteger)nextScreen SWIFT_WARN_UNUSED_RESULT;
+ (void)setNextScreen:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull selectedBrand;)
+ (NSString * _Nonnull)selectedBrand SWIFT_WARN_UNUSED_RESULT;
+ (void)setSelectedBrand:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull selectedStyle;)
+ (NSString * _Nonnull)selectedStyle SWIFT_WARN_UNUSED_RESULT;
+ (void)setSelectedStyle:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull selectedSize;)
+ (NSString * _Nonnull)selectedSize SWIFT_WARN_UNUSED_RESULT;
+ (void)setSelectedSize:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSArray<NSDictionary<NSString *, id> *> * _Nonnull brandsStyleSize;)
+ (NSArray<NSDictionary<NSString *, id> *> * _Nonnull)brandsStyleSize SWIFT_WARN_UNUSED_RESULT;
+ (void)setBrandsStyleSize:(NSArray<NSDictionary<NSString *, id> *> * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSArray<NSDictionary<NSString *, id> *> * _Nonnull styleSize;)
+ (NSArray<NSDictionary<NSString *, id> *> * _Nonnull)styleSize SWIFT_WARN_UNUSED_RESULT;
+ (void)setStyleSize:(NSArray<NSDictionary<NSString *, id> *> * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger countBrandStyleSize;)
+ (NSInteger)countBrandStyleSize SWIFT_WARN_UNUSED_RESULT;
+ (void)setCountBrandStyleSize:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSArray * _Nonnull brandsArray;)
+ (NSArray * _Nonnull)brandsArray SWIFT_WARN_UNUSED_RESULT;
+ (void)setBrandsArray:(NSArray * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSArray * _Nonnull styleArray;)
+ (NSArray * _Nonnull)styleArray SWIFT_WARN_UNUSED_RESULT;
+ (void)setStyleArray:(NSArray * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSArray * _Nonnull sizeArray;)
+ (NSArray * _Nonnull)sizeArray SWIFT_WARN_UNUSED_RESULT;
+ (void)setSizeArray:(NSArray * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger brandCount;)
+ (NSInteger)brandCount SWIFT_WARN_UNUSED_RESULT;
+ (void)setBrandCount:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger styleCount;)
+ (NSInteger)styleCount SWIFT_WARN_UNUSED_RESULT;
+ (void)setStyleCount:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger sizeCount;)
+ (NSInteger)sizeCount SWIFT_WARN_UNUSED_RESULT;
+ (void)setSizeCount:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull brandsArrayData;)
+ (NSString * _Nonnull)brandsArrayData SWIFT_WARN_UNUSED_RESULT;
+ (void)setBrandsArrayData:(NSString * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger countTechSpec;)
+ (NSInteger)countTechSpec SWIFT_WARN_UNUSED_RESULT;
+ (void)setCountTechSpec:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger currentCountTechSpec;)
+ (NSInteger)currentCountTechSpec SWIFT_WARN_UNUSED_RESULT;
+ (void)setCurrentCountTechSpec:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger selectedShapeRow;)
+ (NSInteger)selectedShapeRow SWIFT_WARN_UNUSED_RESULT;
+ (void)setSelectedShapeRow:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger finalRating;)
+ (NSInteger)finalRating SWIFT_WARN_UNUSED_RESULT;
+ (void)setFinalRating:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull finalSize;)
+ (NSString * _Nonnull)finalSize SWIFT_WARN_UNUSED_RESULT;
+ (void)setFinalSize:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull fitpreferStr;)
+ (NSString * _Nonnull)fitpreferStr SWIFT_WARN_UNUSED_RESULT;
+ (void)setFitpreferStr:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull shapeStr;)
+ (NSString * _Nonnull)shapeStr SWIFT_WARN_UNUSED_RESULT;
+ (void)setShapeStr:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull productSizeTS;)
+ (NSString * _Nonnull)productSizeTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setProductSizeTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull chestTS;)
+ (NSString * _Nonnull)chestTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setChestTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull hipTS;)
+ (NSString * _Nonnull)hipTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setHipTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull waistTS;)
+ (NSString * _Nonnull)waistTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setWaistTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull shoulderTS;)
+ (NSString * _Nonnull)shoulderTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setShoulderTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull chestCmTS;)
+ (NSString * _Nonnull)chestCmTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setChestCmTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull hipCmTS;)
+ (NSString * _Nonnull)hipCmTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setHipCmTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull waistCmTS;)
+ (NSString * _Nonnull)waistCmTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setWaistCmTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull shoulderCmTS;)
+ (NSString * _Nonnull)shoulderCmTS SWIFT_WARN_UNUSED_RESULT;
+ (void)setShoulderCmTS:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull waitForSizes;)
+ (NSString * _Nonnull)waitForSizes SWIFT_WARN_UNUSED_RESULT;
+ (void)setWaitForSizes:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull viewUsedToCalculate;)
+ (NSString * _Nonnull)viewUsedToCalculate SWIFT_WARN_UNUSED_RESULT;
+ (void)setViewUsedToCalculate:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull sharedPrefrenceBrand;)
+ (NSString * _Nonnull)sharedPrefrenceBrand SWIFT_WARN_UNUSED_RESULT;
+ (void)setSharedPrefrenceBrand:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull sharedPrefrenceStyle;)
+ (NSString * _Nonnull)sharedPrefrenceStyle SWIFT_WARN_UNUSED_RESULT;
+ (void)setSharedPrefrenceStyle:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull sharedPrefrenceSize;)
+ (NSString * _Nonnull)sharedPrefrenceSize SWIFT_WARN_UNUSED_RESULT;
+ (void)setSharedPrefrenceSize:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger sizeSelectedCountPos;)
+ (NSInteger)sizeSelectedCountPos SWIFT_WARN_UNUSED_RESULT;
+ (void)setSizeSelectedCountPos:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger styleSelectedCountPos;)
+ (NSInteger)styleSelectedCountPos SWIFT_WARN_UNUSED_RESULT;
+ (void)setStyleSelectedCountPos:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger styleTag;)
+ (NSInteger)styleTag SWIFT_WARN_UNUSED_RESULT;
+ (void)setStyleTag:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger sizeTag;)
+ (NSInteger)sizeTag SWIFT_WARN_UNUSED_RESULT;
+ (void)setSizeTag:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSArray<NSDictionary<NSString *, id> *> * _Nonnull finalData;)
+ (NSArray<NSDictionary<NSString *, id> *> * _Nonnull)finalData SWIFT_WARN_UNUSED_RESULT;
+ (void)setFinalData:(NSArray<NSDictionary<NSString *, id> *> * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull profileType;)
+ (NSString * _Nonnull)profileType SWIFT_WARN_UNUSED_RESULT;
+ (void)setProfileType:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull profileName;)
+ (NSString * _Nonnull)profileName SWIFT_WARN_UNUSED_RESULT;
+ (void)setProfileName:(NSString * _Nonnull)value;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
